<template>
  <div>
    ...
    <div class="bg gray">
      <div class="container">
        ...
        <div class="row pb-5 mb-5">
          <div class="col-6">
            <LazyWhydTopMentions ref="topMentions" :url-prefix="urlPrefix" />
          </div>
          <div class="col-6">
            <LazyWhydTopRolePings ref="topRolePings" :url-prefix="urlPrefix" />
          </div>
        </div>
        <div class="row pb-5 mb-5">
          <div class="col-6">
            <LazyWhydTopEmojis ref="topEmojis" :url-prefix="urlPrefix" />
          </div>
          <div class="col-6">
            <LazyWhydTopReactions ref="topReactions" :url-prefix="urlPrefix" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container text-dark">
        ...
        <div class="row py-5">
          <div class="col">
            <h1 class="pt-5">
              you
              <WhydEmoji :url-prefix="urlPrefix" :emoji="':you:'" /> contributed
    ...
    <div class="bg yellow text-dark">
      <WhydLoveSquare :id="id" ref="loveSquare" :url-prefix="urlPrefix" />
    </div>
    ...
    >
      <WhydGoodMorning :id="id" ref="goodMorning" :url-prefix="urlPrefix" />
    </div>
