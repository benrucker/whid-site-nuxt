<template>
  <div id="body">
    <div id="navbar">
      <div id="links">
        <span class="a link current-page" href="scoreboard.html"
          >Scoreboard</span
        >
        <span class="a link" href="score.html" @click="changeWindow"
          >Your Score</span
        >
      </div>
      <div id="logo">
  ...
  head() {
    return {
      ...
      meta: [
        ...
        [
          'og:description',
          'Check your credit score! See how you compare to your best friends 😏\n' +
            this.scores[0]?.name +
            ' is on top with ' +
            this.scores[0]?.score +
            ' this week!',
